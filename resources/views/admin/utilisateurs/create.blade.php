                ...
                <div class="bg-white rounded-[32px] shadow-2xl border border-gray-100 p-8 lg:p-10">
                    ...
                    <?php if ($message === "success"): ?>
                        <div class="bg-green-50 border border-green-200 text-green-800 p-5 rounded-2xl mb-6 text-center animate-fade-up">
                            ...
                            <a href="admin.php" class="inline-block bg-[#27ae60] text-white px-6 py-2 rounded-xl font-bold text-sm hover:bg-[#219150] transition-colors">
                    ...
                    <p class="text-center mt-8 text-gray-500 text-sm">
                        Déjà un compte ? <a href="admin.php" class="text-[#27ae60] font-bold hover:underline">Se connecter</a>
                    </p>
                    <?php endif; ?>
                </div>

                <a href="admin.php" class="block text-center mt-6 text-gray-500 hover:text-[#27ae60] text-sm transition-colors">
