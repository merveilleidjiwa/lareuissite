...
<head>
    ...
    <title>Devenir Livreur - La Réussite</title>
    ...
    <div class="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-black/20 p-8 lg:p-10 transform transition-all">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-black text-gray-800 mb-1">Devenir Livreur</h1>
                <p class="text-gray-500 text-sm font-medium">Rejoignez l'équipe logistique</p>
            </div>
            ...
            <form method="POST" class="space-y-6">
                ...
                <button type="submit" class="btn-auth">
                    <i class="fas fa-sign-in-alt mr-2"></i> S'inscrire comme livreur
                </button>
            </form>
