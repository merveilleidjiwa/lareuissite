...
<div class="page-container">
  ...
  <div class="card">
    ...
    <div class="tabs">
      <a href="{{ url('connexion') }}" class="tab active">Se connecter</a>
      <a href="{{ url('inscription') }}" class="tab ">S'inscrire</a>
    </div>

    <!-- LOGIN -->
    <form id="form-login" class="active" method="POST" action="">
      <div class="card-head">
    ...
    <!-- SIGNUP -->
    <form id="form-signup" class="" method="POST" action="">
      <div class="card-head">
        <h2 class="title">Créer un compte</h2>
        <p class="subtitle">Rejoignez La Réussite Agronomique.</p>
      </div>
